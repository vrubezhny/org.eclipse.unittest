 ...
 *******************************************************************************/
package org.eclipse.debug.unittest.junit.launcher.util;
...
public class Resources {
	...
	private static IStatus addModified(IStatus status, IFile file) {
		IStatus entry = JUnitStatus.createError(MessageFormat.format(JUnitMessages.Resources_fileModified,
		...
		if (status == null) {
			...
			MultiStatus result = new MultiStatus(JUnitTestPlugin.getPluginId(),
					IJUnitStatusConstants.VALIDATE_EDIT_CHANGED_CONTENT, JUnitMessages.Resources_modifiedResources,
					null);
			result.add(status);
			result.add(entry);
			return result;
	...
	private static IStatus addOutOfSync(IStatus status, IResource resource) {
		IStatus entry = new Status(IStatus.ERROR, ResourcesPlugin.PI_RESOURCES, IResourceStatus.OUT_OF_SYNC_LOCAL,
				MessageFormat.format(JUnitMessages.Resources_outOfSync,
