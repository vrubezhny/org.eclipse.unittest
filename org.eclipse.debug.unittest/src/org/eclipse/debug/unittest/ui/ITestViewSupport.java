 ...
 * org.org.eclipse.debug.unittest.unittestViewSupport extension.
 */
public interface ITestViewSupport {
	 ...
	 * @return an action implementing
	 *         org.eclipse.debug.unittest.ui.IOpenEditorAction interface if an
	 *         action can be created, otherwise - null
	 */
