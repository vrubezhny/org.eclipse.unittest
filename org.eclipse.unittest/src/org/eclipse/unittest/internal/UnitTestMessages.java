...
public final class UnitTestMessages extends NLS {

	private static final String BUNDLE_NAME= "org.eclipse.unittest.internal.UnitTestMessages";//$NON-NLS-1$
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, UnitTestMessages.class);
	}

	private UnitTestMessages() {
		// Do not instantiate
	}
