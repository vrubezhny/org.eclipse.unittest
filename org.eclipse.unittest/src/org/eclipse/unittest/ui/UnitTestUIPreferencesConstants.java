...
public class UnitTestUIPreferencesConstants {
	...
	private static final String CODEASSIST_FAVORITE_STATIC_MEMBERS_MIGRATED= UnitTestPlugin.PLUGIN_ID + ".content_assist_favorite_static_members_migrated"; //$NON-NLS-1$
	...
	public static boolean getShowInAllViews() {
		return Platform.getPreferencesService().getBoolean(UnitTestPlugin.PLUGIN_ID, SHOW_IN_ALL_VIEWS, SHOW_IN_ALL_VIEWS_DEFAULT, null);
	}
	...
	public static boolean isCodeassistFavoriteStaticMembersMigrated() {
		return Platform.getPreferencesService().getBoolean(UnitTestPlugin.PLUGIN_ID, CODEASSIST_FAVORITE_STATIC_MEMBERS_MIGRATED, false, null);
	}
