...
public class UnitTestPreferencesConstants {
	 ...
	 */
	public static final String JUNIT3_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit3.javadoclocation"; //$NON-NLS-1$


	/**
	 * Javadoc location for JUnit 4
	 */
	public static final String JUNIT4_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit4.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.hamcrest.core (JUnit 4)
	 */
	public static final String HAMCREST_CORE_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit4.hamcrest.core.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.jupiter.api (JUnit 5)
	 */
	public static final String JUNIT_JUPITER_API_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.jupiter.api.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.jupiter.engine (JUnit 5)
	 */
	public static final String JUNIT_JUPITER_ENGINE_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.jupiter.engine.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.jupiter.migrationsupport (JUnit 5)
	 */
	public static final String JUNIT_JUPITER_MIGRATIONSUPPORT_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.jupiter.migrationsupport.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.jupiter.params (JUnit 5)
	 */
	public static final String JUNIT_JUPITER_PARAMS_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.jupiter.params.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.platform.commons (JUnit 5)
	 */
	public static final String JUNIT_PLATFORM_COMMONS_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.platform.commons.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.platform.engine (JUnit 5)
	 */
	public static final String JUNIT_PLATFORM_ENGINE_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.platform.engine.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.platform.launcher (JUnit 5)
	 */
	public static final String JUNIT_PLATFORM_LAUNCHER_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.platform.launcher.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.platform.runner (JUnit 5)
	 */
	public static final String JUNIT_PLATFORM_RUNNER_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.platform.runner.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.platform.suite.api (JUnit 5)
	 */
	public static final String JUNIT_PLATFORM_SUITE_API_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.platform.suite.api.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.junit.vintage.engine (JUnit 5)
	 */
	public static final String JUNIT_VINTAGE_ENGINE_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.vintage.engine.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.opentest4j (JUnit 5)
	 */
	public static final String JUNIT_OPENTEST4J_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.opentest4j.javadoclocation"; //$NON-NLS-1$

	/**
	 * Javadoc location for org.apiguardian (JUnit 5)
	 */
	public static final String JUNIT_APIGUARDIAN_JAVADOC= UnitTestPlugin.PLUGIN_ID + ".junit5.apiguardian.javadoclocation"; //$NON-NLS-1$
