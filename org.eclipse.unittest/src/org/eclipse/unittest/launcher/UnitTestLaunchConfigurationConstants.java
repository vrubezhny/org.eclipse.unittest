...
public class UnitTestLaunchConfigurationConstants {
	...
	public static final String ID_JUNIT_APPLICATION= "org.eclipse.unittest.launchconfig"; //$NON-NLS-1$
	...
	public static final String ATTR_DONT_ADD_MISSING_JUNIT5_DEPENDENCY= UnitTestPlugin.PLUGIN_ID + ".DONT_ADD_MISSING_JUNIT5_DEPENDENCY"; //$NON-NLS-1$

	/**
	 * If the element is a test class annotated with <code>@RunWith(JUnitPlatform.class)</code>,
	 * this attribute is set to true.
	 */
	public static final String ATTR_RUN_WITH_JUNIT_PLATFORM_ANNOTATION= UnitTestPlugin.PLUGIN_ID + ".IS_RUN_WITH_JUNIT_PLATFORM"; //$NON-NLS-1$
	...
	public static ITestKind getTestRunnerKind(ILaunchConfiguration launchConfiguration) {
		try {
			String loaderId = launchConfiguration.getAttribute(UnitTestLaunchConfigurationConstants.ATTR_TEST_RUNNER_KIND, (String) null);
			if (loaderId != null) {
