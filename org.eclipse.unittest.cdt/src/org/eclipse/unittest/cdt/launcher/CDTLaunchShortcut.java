 ...
 * @since 3.3
 */
public class CDTLaunchShortcut implements ILaunchShortcut2 {
	...
	protected String[] getAttributeNamesToCompare() {
		return new String[] {
				IJavaLaunchConfigurationConstants.ATTR_PROJECT_NAME, UnitTestLaunchConfigurationConstants.ATTR_TEST_CONTAINER,
				IJavaLaunchConfigurationConstants.ATTR_MAIN_TYPE_NAME, UnitTestLaunchConfigurationConstants.ATTR_TEST_NAME
		};
	}
